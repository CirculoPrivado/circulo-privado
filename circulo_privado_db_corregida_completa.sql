...
DROP VIEW IF EXISTS `v_carrito_detalle`;
DROP TABLE IF EXISTS `historial_alertas_emergencia`;
...
--
-- Datos base para la tabla `roles`
--

INSERT INTO `roles` (`codigo`, `nombre`, `descripcion`, `created_at`) VALUES
('admin', 'Administrador', 'Usuario encargado de administrar usuarios, avisos, reportes y configuración general del sistema.', current_timestamp()),
('committee', 'Comité vecinal', 'Usuario con permisos para apoyar en la gestión de avisos, incidentes y organización comunitaria.', current_timestamp()),
('resident', 'Residente', 'Usuario habitante de la comunidad que puede registrar incidentes, consultar avisos, comprar productos y realizar pagos.', current_timestamp()),
('security', 'Seguridad', 'Usuario encargado de revisar alertas de emergencia e incidentes de seguridad.', current_timestamp());
...
CREATE TABLE `avisos` (
  ...
  `categoria` varchar(60) DEFAULT 'Aviso',
...
CREATE TABLE `compra_detalle` (
  ...
  `producto_titulo` varchar(100) DEFAULT NULL,
...
CREATE TABLE `mercado_vecinal` (
  ...
  `condicion_producto` varchar(60) DEFAULT NULL,
  `ubicacion_entrega` varchar(180) DEFAULT NULL,
...
-- Notificaciones internas para campanita/bandeja dentro del sistema.
--
...
-- Guarda los cambios de estado de cada incidente.
--
...
--
-- Estructura de tabla para la tabla `historial_alertas_emergencia`
-- Guarda la atención y cambios de estado de alertas de emergencia.
--

CREATE TABLE `historial_alertas_emergencia` (
  `id` int(11) NOT NULL,
...
ALTER TABLE `notificaciones`
  ...
  ADD KEY `idx_notificaciones_tipo_ref` (`tipo`,`referencia_tabla`,`referencia_id`);
...
ALTER TABLE `historial_incidentes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_historial_incidente` (`incidente_id`),
  ADD KEY `idx_historial_incidente_usuario` (`usuario_id`);

--
-- Indices de la tabla `historial_alertas_emergencia`
--
ALTER TABLE `historial_alertas_emergencia`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_historial_alerta` (`alerta_id`),
  ADD KEY `idx_historial_alerta_usuario` (`usuario_id`);
...
ALTER TABLE `alertas_emergencia`
  ...
  ADD KEY `idx_alertas_atendida_por` (`atendida_por`);
...
ALTER TABLE `avisos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `idx_avisos_estado` (`estado`),
  ADD KEY `idx_avisos_prioridad` (`prioridad`);
...
ALTER TABLE `carritos`
  ...
  ADD KEY `idx_carritos_estado` (`estado`);
...
ALTER TABLE `compras`
  ...
  ADD KEY `idx_compras_pago` (`pago_id`);
...
ALTER TABLE `incidentes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `idx_incidentes_status` (`status`),
  ADD KEY `idx_incidentes_categoria` (`category`),
  ADD KEY `idx_incidentes_asignado_a` (`asignado_a`);
...
ALTER TABLE `mercado_vecinal`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `idx_mercado_estado` (`estado`),
  ADD KEY `idx_mercado_estado_compra` (`estado_compra`),
  ADD KEY `idx_mercado_categoria` (`categoria`);
...
ALTER TABLE `pagos`
  ...
  ADD KEY `idx_pagos_external_reference` (`external_reference`);
...
--
-- AUTO_INCREMENT de la tabla `historial_alertas_emergencia`
--
ALTER TABLE `historial_alertas_emergencia`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `alertas_emergencia`
  ADD CONSTRAINT `alertas_emergencia_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `alertas_emergencia_ibfk_2` FOREIGN KEY (`atendida_por`) REFERENCES `usuarios` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Filtros para la tabla `avisos`
--
ALTER TABLE `avisos`
  ADD CONSTRAINT `avisos_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `carrito_items`
  ADD CONSTRAINT `carrito_items_ibfk_1` FOREIGN KEY (`carrito_id`) REFERENCES `carritos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `carrito_items_ibfk_2` FOREIGN KEY (`producto_id`) REFERENCES `mercado_vecinal` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `compras`
  ...
  ADD CONSTRAINT `compras_ibfk_2` FOREIGN KEY (`pago_id`) REFERENCES `pagos` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Filtros para la tabla `compra_detalle`
--
ALTER TABLE `compra_detalle`
  ADD CONSTRAINT `compra_detalle_ibfk_1` FOREIGN KEY (`compra_id`) REFERENCES `compras` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `compra_detalle_ibfk_2` FOREIGN KEY (`producto_id`) REFERENCES `mercado_vecinal` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

--
-- Filtros para la tabla `grupos`
--
ALTER TABLE `grupos`
  ADD CONSTRAINT `grupos_ibfk_1` FOREIGN KEY (`creado_por`) REFERENCES `usuarios` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
--
ALTER TABLE `incidentes`
  ADD CONSTRAINT `incidentes_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `incidentes_ibfk_2` FOREIGN KEY (`asignado_a`) REFERENCES `usuarios` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Filtros para la tabla `mensajes_grupo`
--
ALTER TABLE `mensajes_grupo`
  ADD CONSTRAINT `mensajes_grupo_ibfk_1` FOREIGN KEY (`grupo_id`) REFERENCES `grupos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `mensajes_grupo_ibfk_2` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Filtros para la tabla `mercado_vecinal`
--
ALTER TABLE `mercado_vecinal`
  ADD CONSTRAINT `mercado_vecinal_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `usuarios_ibfk_role` FOREIGN KEY (`role`) REFERENCES `roles` (`codigo`) ON UPDATE CASCADE;
...
--
ALTER TABLE `historial_incidentes`
  ADD CONSTRAINT `historial_incidentes_ibfk_1` FOREIGN KEY (`incidente_id`) REFERENCES `incidentes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `historial_incidentes_ibfk_2` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Filtros para la tabla `historial_alertas_emergencia`
--
ALTER TABLE `historial_alertas_emergencia`
  ADD CONSTRAINT `historial_alertas_emergencia_ibfk_1` FOREIGN KEY (`alerta_id`) REFERENCES `alertas_emergencia` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `historial_alertas_emergencia_ibfk_2` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- --------------------------------------------------------

--
-- Vista para resumen del panel principal
--
CREATE OR REPLACE VIEW `v_resumen_comunidad` AS
SELECT
  (SELECT COUNT(*) FROM usuarios WHERE activo = 1) AS total_usuarios_activos,
  (SELECT COUNT(*) FROM incidentes WHERE status IN ('Pendiente','En proceso','pendiente','en_proceso')) AS incidentes_abiertos,
  (SELECT COUNT(*) FROM alertas_emergencia WHERE status IN ('enviada','activa','pendiente')) AS alertas_activas,
  (SELECT COUNT(*) FROM avisos WHERE estado = 'activo') AS avisos_activos,
  (SELECT COUNT(*) FROM mercado_vecinal WHERE estado = 'activo' AND estado_compra = 'disponible' AND stock > 0) AS productos_disponibles,
  (SELECT COUNT(*) FROM pagos WHERE estado = 'pagado') AS pagos_pagados,
  (SELECT COUNT(*) FROM pagos WHERE estado <> 'pagado') AS pagos_pendientes;

--
-- Vista para consultar carrito con imagen y datos del producto
--
...
SELECT
  ...
  mv.precio,
  ci.cantidad,
  (mv.precio * ci.cantidad) AS subtotal,
  mv.stock,
  mv.estado,
  mv.estado_compra,
...
INNER JOIN mercado_vecinal mv ON mv.id = ci.producto_id;
